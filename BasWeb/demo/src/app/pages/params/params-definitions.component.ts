...
@Component({
  selector: 'vex-params-definitions',
  templateUrl: './params-definitions.component.html',
  styleUrls: ['./params-definitions.component.scss'],
  animations: [
    stagger20ms,
    fadeInUp400ms,
    scaleFadeIn400ms
...
export class ParamsDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<ParamsDefinitionsComponent>,
