...
@Component({
  selector: 'vex-syndicate-definitions',
  templateUrl: './syndicate-definitions.component.html',
...
export class SyndicateDefinitionsComponent implements OnInit {

  language: any = []; languageMap: LanguageMap = {};
  static id = 100;

  @Input() columns = ['ID', 'Code', 'Name', 'CardNo'];
  @Input() columnsV = ['ID', 'FlexPersonnelGroupID', 'Type', 'Value'];
  form: FormGroup;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<SyndicateDefinitionsComponent>,
  ...
  ngOnInit() {
    ...
    if (this.defaults.Type==="flex")
    this.getFlexGroupPersonel(null);
    else
    this.getFlexGroupWorkingType();
  }
