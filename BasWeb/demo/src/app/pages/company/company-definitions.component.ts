...
@Component({
  selector: 'vex-company-definitions',
  templateUrl: './company-definitions.component.html',
  styleUrls: ['./company.component.scss']
})


export class CompanyDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
               private dialogRef: MatDialogRef<CompanyDefinitionsComponent>,
