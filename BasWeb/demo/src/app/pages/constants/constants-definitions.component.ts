...
@Component({
  selector: 'vex-reasons-definitions',
  templateUrl: './constants-definitions.component.html',
  styleUrls: ['./constants.component.scss']
})


export class ConstantsDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
               private dialogRef: MatDialogRef<ConstantsDefinitionsComponent>,
