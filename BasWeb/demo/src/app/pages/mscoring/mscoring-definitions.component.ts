...
@Component({
  ...
  templateUrl: './mscoring-definitions.component.html',
  styleUrls: ['./mscoring-definitions.component.scss'],
  animations: [
    stagger20ms,
    fadeInUp400ms,
    scaleFadeIn400ms
...
export class MScoringDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<MScoringDefinitionsComponent>,
  ...
  onChecked(e) {
    if (!e.checked) { this.form.patchValue({ CheckText: '' }); this.txtList = '' }
