...
@Component({
  selector: 'vex-system-definitions',
  templateUrl: './system-definitions.component.html',
  styleUrls: ['./system-definitions.component.scss'],
  animations: [
    stagger20ms,
    fadeInUp400ms,
    scaleFadeIn400ms
...
export class SystemDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<SystemDefinitionsComponent>,
