...
@Component({
  selector: 'vex-user-definitions',
  templateUrl: './user-definitions.component.html',
  styleUrls: ['./user-definitions.component.scss'],
  animations: [
    stagger20ms,
    fadeInUp400ms,
    scaleFadeIn400ms
...
export class UserDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<UserDefinitionsComponent>,
