...
@Component({
  selector: 'vex-leaveparams-definitions',
  templateUrl: './leaveparams-definitions.component.html',
  styleUrls: ['./leaveparams-definitions.component.scss'],
  animations: [
    stagger20ms,
    fadeInUp400ms,
    scaleFadeIn400ms
...
export class LeaveParamsDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<LeaveParamsDefinitionsComponent>,
