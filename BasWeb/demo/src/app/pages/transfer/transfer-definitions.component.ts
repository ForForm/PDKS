...
@Component({
  selector: 'vex-transfer-definitions',
  templateUrl: './transfer-definitions.component.html',
  styleUrls: ['./transfer-definitions.component.scss'],
  animations: [
    stagger20ms,
    fadeInUp400ms,
    scaleFadeIn400ms
...
export class TransferDefinitionsComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
    private dialogRef: MatDialogRef<TransferDefinitionsComponent>,
